...
## 10. Referencias internas relevantes

- Agentes/orquestador_agentes/orquestador.py
- Agentes/agente1/code_agente1.py
- Agentes/agente2/run_agente2.py
- Apis2BD_ETL/main.py
- Reporte_Golden_and_Honeypot/README.md
- Silver2Gold_UI/README.md
